 ...
 * 
 * Benefit: Better coordination of control flow between threads. Relinquishes
 * lock on wait()!
 * 
 ...
 * 
 * Limitation: Solves task cooperation in a low-level fashion. Josh Bloch says
 * it is like programming in "concurrency assembly language" Synchronized blocks
 * are needed
 * 
