...
public class NaiveIndexer {
	...
	public static void main(String[] args) {
		...
		// "How do I import a pre-existing Java project into Eclipse and get up and
		// running?",
		...
		// naiveIndexer.add(naiveIndexer.createWeblink(2002, "Interface vs Abstract
		// Class",
		// "http://mindprod.com/jgloss/interfacevsabstract.html",
		// "http://mindprod.com"));
		naiveIndexer
				.add(naiveIndexer.createWeblink(2001, "Portnov School", "http://portnov.net", "http://portnov.net"));
