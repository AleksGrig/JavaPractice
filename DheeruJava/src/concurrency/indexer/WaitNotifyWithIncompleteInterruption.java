...
public class WaitNotifyWithIncompleteInterruption {
			...
			try {
				synchronized (weblink) {
					...
					try {
						...
						System.out
								.println(weblink.getId() + " could not be downloaded. Terminating as stream closed!!!");
						;
					}
				}
				// lock is released
	...
	public static void main(String[] args) {
		...
		incompleteInterruption.add(incompleteInterruption.createWeblink(2000, "Taming Tiger, Part 2",
		...
		incompleteInterruption.add(incompleteInterruption.createWeblink(2002, "Interface vs Abstract Class",
				"http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		incompleteInterruption.add(incompleteInterruption.createWeblink(2003, "Virtual Hosting and Tomcat",
