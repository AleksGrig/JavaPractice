...
import concurrency.indexer.HttpConnect;
 ...
 * 
 * Difference from FutureIndexer: Uses Future's timed get method and an extra
 * catch clause is added for canceling the task
 * 
...
public class FutureTimedGetIndexer {
	...
	public static void main(String[] args) {
		...
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2000, "Taming Tiger, Part 2",
				"http://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html",
				"http://www.javaworld.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2001,
		...
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2002, "Interface vs Abstract Class",
				"http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2004, "Virtual Hosting and Tomcat",
